...
import com.tripleyuan.winter.controller.ApiController;
import com.tripleyuan.winter.controller.ControllerConfiguration;
...
public class DispatcherServletTest {
    ...
    MockServletContext createMockServletContext() {
        Path path = Paths.get("./src/test/resources").toAbsolutePath().normalize();
    ...
    // Map<String, String> Map.of(String... args) {
